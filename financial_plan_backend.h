...
public:
  constant_repayment(double _initial_debt, double _interest_rate,
                     int _total_time);
  ~constant_repayment();
  void compute();
};
...
public:
  constant_annuity(double _initial_debt, double _interest_rate,
                   int _total_time);
  ~constant_annuity();
  void compute();
  double get_annuity();
...
public:
  constant_interest(double _initial_debt, double _interest_rate,
                    int _total_time);
  ~constant_interest();
  void compute();
};
